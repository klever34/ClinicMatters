    ...
    <div class="form-group pull-right">
      ...
      <?php echo message(); ?>
                ...
                <tr>
                  ...
                  <td><a href="delete_patient.php?id=<?php echo urlencode($patient["id"]); ?>" onclick="return confirm('Are you sure You want to delete?');"><button class="btn btn-primary" ><span class="glyphicon glyphicon-trash"></span> Delete</button></a></td>
                  <td><a href="edit_patient.php?id=<?php echo urlencode($patient["id"]); ?>"><button class="btn btn-primary" > <span class="glyphicon glyphicon-pencil"></span> Edit</button></a></td>
