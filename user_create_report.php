...
if (isset($_POST['submit'])) {
  ...
  // validations
  $required_fields = array("pat_report","report_date","reported_by","reg_no","statement");
...
<div class="container" style="padding-top: 10px;">
  ...
  <div class="row">
    ...
    <!-- edit form column -->
      ...
      <form  action="user_create_report.php" method="post" id="registrationForm">
                      ...
                      <fieldset class="form-group">
                          ...
                          <fieldset class="form-group">
                              <div class="col-xs-6">
                                <label for="patient"><h4>Patient</h4></label>
                                  <select class="form-control" name="pat_report" id="pat_report" >
                          ...
                          <div class="form-group col-xs-6">
                            ...
                            <input type="text" id="disabledTextInput" name="reported_by" id="reported_by" class="form-control" placeholder="<?php echo htmlentities($_SESSION["usertype"]); ?> <?php echo htmlentities($_SESSION["username"]); ?>">
                          </div>
                        </fieldset>
                          <fieldset class="form-group">
                              <div class="col-xs-6">
                          ...
                          <div class="form-group">
                               <div class="col-xs-12">
                                  <br>
                                    <a href="user_report.php">Go back</a>
                               </div>
                          </div>
                    </form>
