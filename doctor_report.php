...
<div class="container" style="padding-top: 10px;">
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
      <div class="text-center">
        ...
        <h4>Dr <?php echo htmlentities($_SESSION["doctor_firstname"]); ?></h4>
      </div>
    </div>
  ...
  <ul class="list-group">
    ...
    <a style="text-decoration:none;"href="doctor_report.php"><button><li class="list-group-item">Reports <span class="glyphicon glyphicon-collapse-down"></span></li></button></a>
    ...
    <div class="form-group pull-right">
         <div class="col-xs-12">
              <br>
              <a href="doctor_create_report.php"><button class="btn btn-lg btn-success" type="submit"><i class="glyphicon glyphicon-"></i> Create Report</button></a>
          </div>
    </div>
      <?php echo message(); ?>
