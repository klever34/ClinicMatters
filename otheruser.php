...
<?php $found_user["id"] = $_SESSION["user_id"]; ?>
<!DOCTYPE>
<html>
<head>
  <title>Users</title>
...
<div class="container" style="padding-top: 10px;">
  <h1 class="page-header"><span class="glyphicon glyphicon-user"></span> User</h1>
  <div class="row">
    <!-- left column -->
    <div class="col-md-4 col-sm-6 col-xs-12">
      <div class="text-center">
        ...
        <h4><span class="glyphicon glyphicon-user"></span> Welcome <?php echo htmlentities($_SESSION["usertype"]); ?> <?php echo htmlentities($_SESSION["username"]); ?></h4>
      </div>
    </div>
  ...
  <div class="panel-body">
    <p>Signed in as <?php echo htmlentities($_SESSION["user_email"]); ?></p>
  </div>

  <!-- List group -->
  <ul class="list-group">
    <button><li class="list-group-item"><a style="text-decoration:none;"href="">Questionnaires <span class="glyphicon glyphicon-collapse-down"></span></a></li></button>
    <button><li class="list-group-item"><a style="text-decoration:none;"href="user_manage_patients.php">Manage Patients <span class="glyphicon glyphicon-collapse-down"></span></a></li></button>
    <button><li class="list-group-item"><a style="text-decoration:none;"href="user_report.php">Reports <span class="glyphicon glyphicon-collapse-down"></span></a></li></button>
    <button><li class="list-group-item"><a style="text-decoration:none;"href="edit_account.php?id=<?php echo urlencode($found_user["id"]); ?>">Edit Account <span class="glyphicon glyphicon-pencil"></span></a></li></button>
