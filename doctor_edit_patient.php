...
<header>
  ...
  <form class="form" action="doctor_edit_patient.php?id=<?php echo urlencode($patient["id"]); ?>" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                ...
                                <a href="doctor.php"><button type="submit" class="btn btn-primary"> Cancel </button></a>
                                <br><br>

                                <span class="glyphicon glyphicon-arrow-left"></span> <a href="doctor.php">Go back</a>
                           </div>
                      </div>
                </form>
